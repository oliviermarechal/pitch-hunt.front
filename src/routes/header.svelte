...
<header class="p-5 bg-black">
    <nav class="flex justify-between items-center w-full">
        <div id="logo"><a href="/"><img src="/images/logo.png" alt="logo Pitch hunt" /></a></div>
...
<Modal open={$displayLoginForm} onClose={() => hideLoginForm()}>
    <div slot="head">Please login</div>
    <div slot="body"><Login onCancel={hideLoginForm} handleLogin={handleLogin} /></div>
</Modal>
<Modal open={$displayRegistrationForm} onClose={() => hideRegistrationForm()}>
